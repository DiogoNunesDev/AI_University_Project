...
public class Main {
  ...
  public static void main(String[] args) {
    ...
    pacmanNeuralNetwork.addLayer(256, 64, "relu");
    //pacmanNeuralNetwork.addLayer(128, 64, "relu");
    //pacmanNeuralNetwork.addLayer(64, 32, "relu");
    ...
    GeneticAlgo_V2 genAlgo = new GeneticAlgo_V2(pacmanNeuralNetwork, 2500, 1000, 0.15, 1, 10, 0.05);
